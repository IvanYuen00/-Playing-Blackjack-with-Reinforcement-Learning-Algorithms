...
# constant alpha
def sarsa(env, episodes, alpha, gamma, evaluating_episodes):
    ...
    for i in range(episodes):
        ...
        while not done:
            ...
            delta = reward + gamma * Q[next_state][next_action] - Q[now_state][now_action]
...
q, evaluations, policy = sarsa(env, 1000000, 0.001, 0.4, 10000)
